...
@section('content')
    ...
    <div class="container my-5">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <a href="{{ route('list.kucing') }}" class="text-decoration-none">
            ...
            <div class="col">
                <a href="{{ route('list.anjing') }}" class="text-decoration-none">
                    <div class="card h-100 shadow-sm">
            ...
            <div class="col">
                <a href="{{ route('list.hamster') }}" class="text-decoration-none">
                    <div class="card h-100 shadow-sm">
                        {{-- <img src="..." class="card-img-top" alt="..."> --}}
                        {{-- img hamster --}}
